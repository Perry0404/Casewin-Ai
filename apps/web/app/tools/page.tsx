    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-green-900 to-gray-900">
      ...
      <div className="bg-gradient-to-r from-green-800/50 to-emerald-800/50 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">AI Legal Tools</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {tools.map((tool) => (
            ...
            >
              ...
              <div className="p-5">
                <h3 className="text-lg font-bold text-white mb-2 group-hover:text-green-400 transition">{tool.title}</h3>
                <p className="text-gray-400 text-sm mb-4">{tool.description}</p>
                <div className="flex flex-wrap gap-2">
                  {tool.features.map((feature) => (
                    <span key={feature} className="bg-gray-700/50 text-gray-300 px-2 py-1 rounded-full text-xs">{feature}</span>
                  ))}
                </div>
              </div>
        ...
        <div className="mt-16 bg-gray-800/50 backdrop-blur-sm rounded-xl p-8 border border-green-500/20 max-w-2xl mx-auto text-center">
          ...
          <p className="text-gray-400 mb-6">
            Verified lawyers get access to 12 professional tools including Time &amp; Billing, Case Manager,
            Hearing Prep, AI Chatbot, Daily Intelligence Brief, and more.
          </p>
          <Link
            href="/marketplace"
