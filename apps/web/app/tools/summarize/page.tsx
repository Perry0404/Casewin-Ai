...
export default function SummarizePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-indigo-900 to-gray-900">
      {/* Navigation */}
      <nav className="bg-black/30 backdrop-blur-md border-b border-indigo-500/20">
      ...
      {/* Header */}
      <div className="bg-gradient-to-r from-indigo-800/50 to-blue-800/50 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center space-x-4">
            <div className="w-16 h-16 bg-gradient-to-br from-indigo-500 to-blue-500 rounded-xl flex items-center justify-center text-3xl">
              📋
            </div>
            <div>
          ...
          <div className="space-y-6">
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/20">
              ...
              <button
                ...
                className="w-full mt-4 bg-gradient-to-r from-indigo-600 to-blue-600 hover:from-indigo-700 hover:to-blue-700 disabled:from-gray-600 disabled:to-gray-600 text-white py-3 rounded-lg font-semibold transition flex items-center justify-center space-x-2"
              >
                {isSummarizing ? (
                  <>
            ...
            {summary ? (
              <>
                ...
                <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/20">
                  ...
                  <p className="text-indigo-400 mb-3">{summary.citation}</p>
                ...
                {/* Facts */}
                <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-5 border border-indigo-500/20">
                  <h3 className="font-semibold text-indigo-400 mb-2">📖 Facts of the Case</h3>
                  <p className="text-gray-300 text-sm">{summary.facts}</p>
                </div>

                {/* Issues */}
                <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-5 border border-indigo-500/20">
                  <h3 className="font-semibold text-indigo-400 mb-2">❓ Issues for Determination</h3>
                ...
                <div className="bg-indigo-900/30 border border-indigo-500/30 rounded-xl p-5">
                  <h3 className="font-semibold text-indigo-400 mb-2">⚖️ Holding (Decision)</h3>
                ...
                {/* Actions */}
                <div className="flex space-x-4">
                  <button className="flex-1 bg-indigo-600 hover:bg-indigo-700 text-white py-2 rounded-lg font-semibold transition">
                    📄 Download Summary
                  </button>
              ...
              <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/20 h-[600px] flex items-center justify-center">
